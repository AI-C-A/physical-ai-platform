...
export function createUnavailableFlywheel(): FlywheelPort {
  return {
    ...
    listTemplates: empty,
    listSessions: empty,
    listOperationalSessions: reject,
    deleteOperationalSession: reject,
    getSession: () => Promise.resolve(null),
    getCollectionTelemetry: () => Promise.resolve(null),
    getEpisodeHandPoseAt: () => Promise.resolve(null),
    ...
    stopEpisode: reject,
    saveEpisode: reject,
    deleteEpisode: reject,
    setEpisodeOutcome: reject,
    retryEpisodeFinalization: reject,
    invalidateEpisode: reject,
    completeEpisode: reject,
    retrySessionProcessing: reject,
    abandonSession: reject,
    reportStreamFailure: reject,
    listCatalogCollections: empty,
    getCatalogCollection: () => Promise.resolve(null),
    deleteCatalogCollection: reject,
